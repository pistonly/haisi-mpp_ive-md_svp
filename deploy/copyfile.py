...
if __name__ == '__main__':
    ...
    commands = [
        f'mkdir -p {mount_dir} && mount -t nfs -o nolock 192.168.0.111:/d/nfs_share {mount_dir}; mkdir -p {target_dir} && rm -r {target_dir}/*',
        f'''nohup sh -c "cp -r {mount_work_dir}/* {target_dir}/ && cp {mount_work_dir}/S81app /etc/init.d/ && chmod +x /etc/init.d/S81app && reboot" > /root/copyfile.log 2>&1 &''',
    ]
